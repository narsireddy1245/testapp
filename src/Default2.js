          ...
          <div className="col-12 col-md-5">
            <div className="cardlogin shadow ">
              ...
              <div className=" text-center reactbtngroup">
                <button className="w-25 reactloginbtn shadow mx-1">Login</button>
              ...
              <div className=" text-center reactbtngroup mt-3 mb-3">
                ...
                <button className="w-25 reactloginbtn1 shadow">Job seekers<input type="radio" name="type" value="jobseeker" onChange={((e)=>setSelectedType(e.target.value))} ></input></button>
                <button className="w-25 reactloginbtn shadow">Recruiters<input type="radio" name="type"  value="recruiter" onChange={((e)=>setSelectedType(e.target.value))}></input></button>
              </div>
