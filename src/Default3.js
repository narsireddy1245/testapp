          ...
          <div className="col-12 col-md-5">
            <div className="cardlogin shadow ">
              ...
              <div className=" text-center reactbtngroup mt-3 mb-3">
                ...
                <button className="w-25 reactloginbtn1 shadow">Job seekers<input type="radio" name="type" value=""  ></input></button>
                <button className="w-25 reactloginbtn shadow">Recruiters<input type="radio" name="type"  value="" ></input></button>
              </div>
